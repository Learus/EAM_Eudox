...
#### Ανάλυση Εργασιών Δήλωσησ Συγγράμματος
...
1. Είσοδος στην αρχική σελίδα του Εύδοξου
    ...
    * Πατάει το bookmark που έβαλε στο browser του, αφότου του δόθηκε απο τον προϊστάμενο.
...
>
> Αμέσως μετά, έχοντας συνεννοηθεί με το βιβλιοπωλείο του οίκου που βρίσκεται λίγο πιο κάτω, το επιλέγει ως σημείο διανομής από τη λίστα που εμφανίζεται. 
>
