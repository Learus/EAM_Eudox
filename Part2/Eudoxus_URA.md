...
#### Σενάριο Χρήσης Δήλωσης
    ...
    Ο Παναγιώτης πρόκειται να χρησιμοποιήσει για πρώτη φορά τον Εύδοξο. Του είπαν οι συμφοιτητές του το όνομα του ιστοχώρου και το έπσαξε στο Google. Στόχο έχει να δηλώσει τα συγγράμματα των μαθημάτων που θα παρακολουθήσει αυτό το εξάμηνο στη σχολή του. Αρχικά, βρίσκεται στην κεντρική σελίδα και παρατηρεί τα 4 χρωματισμένα κουτιά. Κάνει  mouse over πάνω απο την κατηγορία φοιτητές και εμφανίζεται το υπομενού με τις επιλογές του φοιτητή. Έπειτα, κάνει κλικ στο κουμπί "Δήλωση Συγγραμμάτων" και ανοίγει ένα pop-up που απαιτεί σύνδεση/δημιουργία λογαριασμού. Δεδομένου οτι είναι η πρώτη του φορά, επιλέγει να εγγραφεί στο σύστημα. Παντώντας "Εγγραφή" μεταβιβάζεται σε μια νέα σελίδα όπου του ζητούνται οι απαραίτητες πληροφορίες:
        1. Αριθμός Μητρώου
        ...
        5. Email
        6. Password
    Πατάει "Εγγραφή" και μεταφέρεται στη σελίδα δήλωσης συγγραμμάτων. Εκεί, 
