# 1. Ανάλυση Απαιτήσεων Χρήστη (User Requirement Analysis)

## Περιεχόμενα

* [1. Ανάλυση Απαιτήσεων Χρήστη (User Requirement Analysis)](#1-ανάλυση-απαιτήσεων-χρήστη-user-requirement-analysis)
    * [1.1. Ομάδες Χρηστών](#11-ομάδες-χρηστών)
    * [1.2. Περσόνες](#12-περσόνες)
        * [1.2.1. Παναγιώτης Παναγόπουλος - Φοιτητής](#121-παναγιώτης-παναγόπουλος---φοιτητής)
        * [1.2.2. Μανώλης Κανάκης - Προμηθευτής](#122-μανώλης-κανάκης---προμηθευτής)
        * [1.2.3. Σούλα Ευγενίδου - Γραμματεία](#123-σούλα-ευγενίδου---γραμματεία)
        * [1.2.4. Νίκος Κωστέας - Διανομέας](#124-νίκος-κωστέας---διανομέας)
    * [1.3. Ανάλυση Εργασίων - Σενάρια Χρήσης](#13-ανάλυση-εργασίων---σενάρια-χρήσης)
        * [1.3.1. Φοιτητής - Δήλωση Συγγραμμάτων](#131-φοιτητής---δήλωση-συγγραμμάτων)
            * [1.3.1.1. Ανάλυση Εργασιών Δήλωσης Συγγράμματος](#1311-ανάλυση-εργασιών-δήλωσης-συγγράμματος)
            * [1.3.1.2. Σενάριο Χρήσης Δήλωσης Συγγράμματος](#1312-σενάριο-χρήσης-δήλωσης-συγγράμματος)
        * [1.3.2. Εκδότης - Καταχώριση Συγγράμματος](#132-εκδότης---καταχώριση-συγγράμματος)
            * [1.3.2.1. Ανάλυση Εργασιών Καταχώρισης Συγγράμματος](#1321-ανάλυση-εργασιών-καταχώρισης-συγγράμματος)
            * [1.3.2.2. Σενάριο Χρήσης Καταχώρισης Συγγράμματος](#1322-σενάριο-χρήσης-καταχώρισης-συγγράμματος)
    * [1.4. Ανάλυση απαιτήσεων - Καταγραφή προδιαγραφών](#14-ανάλυση-απαιτήσεων---καταγραφή-προδιαγραφών)
    * [1.5. Sitemap](#15-sitemap)
...
### 1.2.1. Παναγιώτης Παναγόπουλος - Φοιτητής
...
### 1.2.2. Μανώλης Κανάκης - Προμηθευτής
...
### 1.2.3. Σούλα Ευγενίδου - Γραμματεία
...
## 1.3. Ανάλυση Εργασίων - Σενάρια Χρήσης

---

### 1.3.1. Φοιτητής - Δήλωση Συγγραμμάτων

#### 1.3.1.1. Ανάλυση Εργασιών Δήλωσης Συγγράμματος
...
#### 1.3.1.2. Σενάριο Χρήσης Δήλωσης Συγγράμματος
...
### 1.3.2. Εκδότης - Καταχώριση Συγγράμματος

#### 1.3.2.1. Ανάλυση Εργασιών Καταχώρισης Συγγράμματος
...
#### 1.3.2.2. Σενάριο Χρήσης Καταχώρισης Συγγράμματος
...
## 1.4. Ανάλυση απαιτήσεων - Καταγραφή προδιαγραφών
